...
const struct cmd_desc cmdlist[] = {
    ...
    {"enhance", "advance or check weapon and spell skills", M('e'), 0, TRUE,
     enhance_weapon_skill, CMD_ARG_NONE | CMD_EXT, NULL},
    ...
    {"fight", "attack even if no hostile monster is visible", 'F', 0, FALSE,
     dofight, CMD_ARG_DIR, NULL},
    {"fire", "throw your quivered item", 'f', 0, FALSE, dofire, CMD_ARG_NONE, NULL},
    ...
    {"license", "show the NetHack license", 0, 0, TRUE, dolicense,
     CMD_ARG_NONE | CMD_HELP | CMD_NOTIME, NULL},
    ...
    {"monster", "use a monster's special ability", 'M', M('m'), TRUE,
     domonability, CMD_ARG_NONE | CMD_EXT, NULL},
    {"multidrop", "drop multiple items", 'D', 0, FALSE, doddrop, CMD_ARG_NONE, NULL},
    {"name", "name a monster, item or type of object", M('n'), 'C', TRUE,
     do_naming, CMD_ARG_NONE | CMD_EXT, NULL},
    {"name mon", "christen a monster", 0, 0, TRUE, do_mname, CMD_ARG_NONE, NULL},
    ...
    {"open", "open, close or unlock a door", 'o', 0, FALSE, doopen,
     CMD_ARG_NONE | CMD_ARG_DIR, NULL},
    {"overview", "show an overview of the dungeon", C('o'), 0, TRUE, dooverview,
     CMD_ARG_NONE | CMD_EXT | CMD_NOTIME, NULL},
    {"pay", "pay a shopkeeper", 'p', 0, FALSE, dopay, CMD_ARG_NONE, NULL},
    ...
    {"sacrifice", "offer a sacrifice to the gods", M('o'), 0, FALSE,
     dosacrifice, CMD_ARG_NONE | CMD_EXT | CMD_ARG_OBJ, NULL},
    {"save", "save the game and exit", 'S', 0, TRUE, dosave, CMD_ARG_NONE, NULL},
    ...
    {"showamulets", "list the amulets in your inventory", '"', 0, TRUE,
     dopramulet, CMD_ARG_NONE | CMD_NOTIME, NULL},
    ...
    {"showworn", "show the items you are wearing", '*', 0, TRUE, doprinuse,
     CMD_ARG_NONE | CMD_NOTIME, NULL},
    {"sit", "sit down", M('s'), 0, FALSE, dosit, CMD_ARG_NONE | CMD_EXT, NULL},
    {"spellbook", "display and change letters of spells", '+', 0, TRUE,
     dovspell, CMD_ARG_NONE, NULL},
    {"swapweapon", "exchange wielded and alternate weapon", 'x', 0, FALSE,
     doswapweapon, CMD_ARG_NONE, NULL},
    ...
    {"teleport", "use intrinsic or magical teleportation ability", C('t'), 0,
     TRUE, dotele, CMD_ARG_NONE, NULL},
    {"throw", "throw an item", 't', 0, FALSE, dothrow,
     CMD_ARG_NONE | CMD_ARG_OBJ, NULL},
    {"togglepickup", "toggle the autopickup option", '@', 0, TRUE,
     dotogglepickup, CMD_ARG_NONE, NULL},
    {"travel", "walk until a given square is reached", '_', 0, TRUE, dotravel,
     CMD_ARG_NONE | CMD_ARG_POS, NULL},
    {"turn", "turn undead", M('t'), 0, TRUE, doturn, CMD_ARG_NONE | CMD_EXT, NULL},
    ...
    {"version", "displays the version number", 0, 0, TRUE, doversion,
     CMD_HELP | CMD_ARG_NONE | CMD_NOTIME | CMD_EXT, NULL},
